...
angular.module('docs').controller('DocumentEdit', function($rootScope, $scope, $q, $http, $state, $stateParams, Restangular, $translate) {
    ...
    $scope.addReview = function() {
        ...
        document.reviewList = [document.review.gpa, document.review.skills_rating, document.review.work_rating, document.review.research_rating, document.review.letter_rating];
        $scope.document = document;
        console.log($scope.document.reviewList);
        $scope.edit();
    }
    ...
    $scope.edit = function() {
        ...
        console.log("values" + document.reviewList);
        // Send to server
        if ($scope.isEdit()) {
