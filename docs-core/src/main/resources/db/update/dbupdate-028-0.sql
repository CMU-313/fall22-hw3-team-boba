create memory table T_REVIEW ( REV_ID_C varchar(36) not null, REV_IDDOC_C varchar(36) not null, REV_IDUSER_C varchar(36) not null, REV_GPA_N int, REV_REX_N int, REV_WEX_N int, REV_SKILLS_N int, REV_LOR_N int, REV_CREATEDATE_D datetime, primary key (REV_ID_C) );
